...
_PathStyle_ if set to _Kebeb_, changes the file and directory names to kebeb-case. If it isn't set, the default behaviour applies which leaves the directory names as they are in the working directory and change the file names to camelCase.
